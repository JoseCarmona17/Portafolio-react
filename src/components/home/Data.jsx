...
export const Data = () => {
    return (
        <div className="home__data">
            ...
            <p className="home__description">Desarrollador Full Stack enfocado en la creación de aplicaciones web modernas, sistemas impulsados por inteligencia artificial y arquitecturas backend escalables.

                Apasionado por tecnologías como React, FastAPI y Python, actualmente desarrollo proyectos relacionados con machine learning, automatización, comunicación en tiempo real y soluciones web modernas.</p>
